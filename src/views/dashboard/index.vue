    ...
    <el-row :gutter="20">
      <el-col :span="13">
        <div class="grid-content bg-purple">
          <div class="title">工单统计<span class="time">2022</span></div>
          <div class="body">
            <div class="stats">
            ...
            <div class="stats">
              <span class="num">0</span>
              <p class="text">进行工单（元）</p>
            </div>
            <div class="stats">
              <span class="num">0</span>
              <p class="text">取消工单（元）</p>
            </div>
          </div>
        </div>
      </el-col>
      <el-col :span="11">
        <div class="grid-content bg-purple-light">
          <div class="title">销售统计<span class="time">2022</span></div>
          <div class="body">
            <div class="stats">
              <span class="num monthNum">1</span>
              <p class="text monthText">订单量（个）</p>
            </div>
            <div class="stats">
              <span class="num monthNum">0</span>
              <p class="text monthText">销售额（万元）</p>
            </div>
          </div>
        </div>
      </el-col>
    </el-row>
    <div class="sku-sale-collec box">
      <div class="title">销售数据<span class="time">2022</span></div>
      <el-row :gutter="20" class="charts">
        <el-col :span="12">111
          <div id="trend" class="chart" />
        </el-col>
        <el-col :span="12">111
          <div id="distribute" class="chart" />
        </el-col>
      </el-row>
    </div>
  </div>
